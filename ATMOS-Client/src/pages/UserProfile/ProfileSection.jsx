...
const ProfileSection = ({ user, setUser }) => {
  ...
  const handleFileSubmit = async (e) => {
    try {
      ...
      const res = await fetch(`${backendUrl}/user/uploadAvatar`, {
        method: "POST",
      ...
      <Container className="profile-container py-3 my-0">
        <Card className="profile-card">
          <Card.Body className="d-flex align-items-center justify-content-between">
            <p
              className="fs-2 profile-heading fw-semibold align-items-center"
              style={{ color: "#05386B" }}
            >
              Profile
            </p>
            <div>
              <Button
                ...
                onClick={!isEdit ? () => setIsEdit(!isEdit) : handleClick}
              >
                {isEdit ? (
          ...
          <Col md={4} sm={12} className="mb-3">
            <Card className={styles.profileCard + ` shadow`}>
              ...
              <Card.Body className="text-center">
                ...
                <h1
                  className="profile-heading fw-semibold mt-3"
                  style={{ color: "#05386B" }}
                >
                  {userName}
                </h1>
              ...
              <Card.Body className="profile-card-body">
                <Row className="mb-3">
                  ...
                  <Col className="text-center" lg={10} sm={12}>
                    ...
                    {!isEdit && (
                      <div
                        className=" fw-bold border-bottom border-dark border-opacity-50 fs-5"
                        style={{ color: "#05386B" }}
                      >
                        {userName}
                      </div>
                ...
                <Row className="mb-3">
                  ...
                  <Col className="text-center" lg={10} sm={12}>
                    ...
                    {!isEdit && (
                      <div
                        className="fw-bold border-bottom border-dark border-opacity-50 fs-4"
                        style={{ color: "#05386B" }}
                      >
                        ....................
                      </div>
              ...
              <Col md={6} lg={4} sm={12}>
                <div className={styles.countContainer}>
                  ...
                  <div className={styles.containerFoot}>
                    <p className={styles.para}>TOTAL PROJECTS</p>
                  </div>
                </div>
              </Col>
              <Col lg={4} md={6} sm={12}>
                  ...
                  <div className={styles.containerBody}>
                    <p className={styles.para}>
                      {user.favProjectIdList
                        ? user.favProjectIdList.length
                        : "0"}
                    </p>
                  </div>
                  <div className={styles.containerFoot}>
                    <p className={styles.para}>TOTAL FAVOURITES</p>
                  </div>
                </div>
              </Col>
              <Col md={6} lg={4} sm={12}>
                <div className={styles.countContainer}>
                  ...
                  <div className={styles.containerBody}>
                    <p className={styles.para}>
                      {user.taskAssignedIDList
                        ? user.taskAssignedIDList.length
                        : "0"}
                    </p>
                  </div>
                  <div className={styles.containerFoot}>
                    <p className={styles.para}>TOTAL TASKS</p>
                  </div>
                </div>
              </Col>
            </Row>
