...
const TaskCard = ({ task }) => {
  ...
  const updateLastUsed = async (projectId) => {
    const res = await fetch(
      `${backendUrl}/project/updateLastUsed/${projectId}`,
      {
        method: "PUT",
        headers: {
    ...
    <>
      ...
      >
        <Group position="apart">
          ...
          <Text color={"#05386b"} sx={{ fontFamily: "Poppins" }} size="sm">
            due: {dateFormatter(task.taskDeadline)}
          </Text>
        </Group>
      </Paper>
    </>
