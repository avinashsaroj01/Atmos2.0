...
const Datatable = ({alldata, type}) => {
  ...
  const handleDelete = async (id, type) => {
    try {
      ...
      const res = await fetch(`${backendUrl}/admin/${type}/${id}`, {
        method: "DELETE",
            ...
            renderCell: (params) => {
              return (
                <div className="cellWithImg">
                  <img
                    className="cellImg"
                    src={params.row.projectOwner.avatar}
                    alt="avatar"
                  />
      ...
      typeData = {
        columns: [
          { field: "_id", headerName: "ID", width: 190 },
          {
            ...
            renderCell: (params) => {
              return (
                <div className="cellWithProjectName">{params.row.taskName}</div>
              );
            },
          },
            ...
            renderCell: (params) => {
              return (
                <div className="cellWithImg">
                  <img
                    className="cellImg"
                    src={params.row.taskCreator.avatar}
                    alt="avatar"
                  />
      ...
      renderCell: (params) => {
        return (
          <div className="cellAction">
            <Link
              to={"/admin-portal/" + type + "/" + params.row._id}
